...
export const api = {
  ...
  startFullDeckGeneration: (id, payload) => request(`/api/projects/${encodeURIComponent(id)}/full-deck/generation-sessions`, { method: "POST", body: JSON.stringify(payload) }),
  fullDeckGenerationSession: (id, sessionId) => request(`/api/projects/${encodeURIComponent(id)}/full-deck/generation-sessions/${encodeURIComponent(sessionId)}`),
  pauseFullDeckGeneration: (id, sessionId, sessionVersion) => request(`/api/projects/${encodeURIComponent(id)}/full-deck/generation-sessions/${encodeURIComponent(sessionId)}/pause`, { method: "POST", body: JSON.stringify({ session_version: sessionVersion }) }),
  resumeFullDeckGeneration: (id, sessionId, sessionVersion) => request(`/api/projects/${encodeURIComponent(id)}/full-deck/generation-sessions/${encodeURIComponent(sessionId)}/resume`, { method: "POST", body: JSON.stringify({ session_version: sessionVersion }) }),
  retryFullDeckGeneration: (id, sessionId, sessionVersion) => request(`/api/projects/${encodeURIComponent(id)}/full-deck/generation-sessions/${encodeURIComponent(sessionId)}/retry`, { method: "POST", body: JSON.stringify({ session_version: sessionVersion }) }),
  cancelFullDeckGeneration: (id, sessionId, sessionVersion) => request(`/api/projects/${encodeURIComponent(id)}/full-deck/generation-sessions/${encodeURIComponent(sessionId)}/cancel`, { method: "POST", body: JSON.stringify({ session_version: sessionVersion }) }),
  addFullDeckGenerationDirective: (id, sessionId, payload) => request(`/api/projects/${encodeURIComponent(id)}/full-deck/generation-sessions/${encodeURIComponent(sessionId)}/directives`, { method: "POST", body: JSON.stringify(payload) }),
  fullDeckGenerationPreviewUrl: (id, sessionId, path, version) => `/api/projects/${encodeURIComponent(id)}/full-deck/generation-sessions/${encodeURIComponent(sessionId)}/preview/${String(path).split("/").map(encodeURIComponent).join("/")}?v=${encodeURIComponent(version)}`,
